...
<head>
  ...
  <title>VOX-Event</title>
  <!-- Custom fonts for this template-->
  <link href="{{ asset(config('app.be_asset').'/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">
	<link rel="icon" type="image/png" href="{{ asset('storage/laravel.png') }}">

  <!-- Custom styles for this template-->
  <link href="{{ asset(config('app.be_asset').'/css/sb-admin-2.min.css') }}" rel="stylesheet">
  <script src="{{ asset(config('app.be_asset').'/vendor/jquery/jquery.min.js') }}"></script>
